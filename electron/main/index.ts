...
// Storage strategy:
// 1. Main window: partition 'persist:main_window' in app userData → ATAI account (persistent)
...
// Local HTTP server for receiving auth callbacks from external login (atai.ai)
    ...
    if (url.pathname === '/auth/callback') {
      ...
      res.end(`
        ...
        <body><div class="container">
          ...
          <p>You can close this tab and return to ATAI.</p>
        </div></body></html>
      `);
