...
import ataiLogo from '@/assets/logo/atai_icon.png';
...
export default function Login() {
  ...
  // Listen for direct token callback from Electron (ATAI login redirect)
  useEffect(() => {
  ...
  // Render local mode: "Start ATAI" button only
    ...
    <div className="w-80 pt-8 relative flex flex-1 flex-col items-center justify-center">
      ...
      >
        <span className="flex-1">
          {isLoading ? t('layout.logging-in') : 'Start ATAI'}
        </span>
      </Button>
    </div>
  );
