...
class SkillToolkit(BaseSkillToolkit):
    """Enhanced SkillToolkit with ATAI-specific features.

    Extends CAMEL's SkillToolkit with:
    - User-specific skill configuration
    - Agent-based access control
    - ATAI-specific skill paths (.eigent/skills)
    ...
    def __init__(
        ...
        """Initialize SkillToolkit with ATAI-specific context.
    ...
    def _skill_roots(self) -> list[tuple[str, Path]]:
        """Return skill roots with ATAI + CAMEL paths.

        Integrates ATAI-specific paths with CAMEL standard paths.
