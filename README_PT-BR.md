...
[![][image-head]][atai-site]

[![][image-seperator]][atai-site]

### ATAI: O Desktop Cowork Open Source para Desbloquear sua Produtividade Excepcional

<!-- SHIELD GROUP -->

[![][download-shield]][atai-download]
[![][github-star]][atai-github]
...
[English](./README.md) · **Português** · [简体中文](./README_CN.md) · [日本語](./README_JA.md) · [Site Oficial][atai-site] · [Documentação][docs-site] · [Feedback][github-issue-link]

</div>
<br/>

**ATAI** é a aplicação desktop Cowork código aberto que capacita você a construir, gerenciar e implantar uma força de trabalho de IA personalizada, capaz de transformar seus fluxos de trabalho mais complexos em tarefas automatizadas. Como um produto líder de Cowork código aberto, o ATAI reúne o melhor da colaboração open source e da automação impulsionada por IA.
...
> **🔓 Construído em Público** — ATAI é **100% open source** desde o primeiro dia. Cada funcionalidade, cada commit e cada decisão são transparentes. Acreditamos que as melhores ferramentas de IA devem ser construídas abertamente com a comunidade, e não a portas fechadas.

### 🏠 Implantação Local (Recomendado)

A forma recomendada de executar o ATAI — totalmente independente, com controle completo sobre seus dados, sem necessidade de conta em nuvem.
...
```bash
git clone https://github.com/atai-ai/atai.git
cd atai
npm install
npm run dev
```

> Nota: Este modo se conecta aos serviços em nuvem do ATAI e requer registro de conta. Para uma experiência totalmente independente, utilize a [Implantação Local](#-implanta%C3%A7%C3%A3o-local-recomendado) em vez disso.
...
📧 Para mais detalhes, entre em contato conosco em [info@atai.ai](mailto:info@atai.ai).

### ☁️ Versão em Nuvem

Para equipes que preferem infraestrutura gerenciada, também oferecemos uma plataforma em nuvem. A maneira mais rápida de experimentar as capacidades de IA multi-agente do ATAI sem complexidade de configuração. Nós hospedaremos os modelos, APIs e armazenamento em nuvem, garantindo que o ATAI funcione perfeitamente.
...
[![image-public-beta]][atai-download]

<div align="right">
<a href="https://www.atai.ai/download">Comece em ATAI.ai →</a>
</div>

## **✨ Principais recursos - Cowork Open Source**

Desbloqueie todo o potencial de produtividade excepcional com os poderosos recursos do ATAI Cowork código aberto—construídos para integração perfeita, execução de tarefas mais inteligente e automação ilimitada.

### 🏭 Força de Trabalho

Emprega uma equipe de agentes de IA especializados que colaboram para resolver tarefas complexas. O ATAI Cowork código aberto divide dinamicamente as tarefas e ativa múltiplos agentes para trabalhar **em paralelo.**

O ATAI pré-definiu os seguintes agentes trabalhadores:
...
![Workforce](https://atai-ai.github.io/.github/assets/gif/feature_dynamic_workforce.gif)

<br/>

### 🧠 Suporte Abrangente a Modelos

Implante o desktop ATAI Cowork código aberto localmente com seus modelos preferidos.

![Model](https://atai-ai.github.io/.github/assets/gif/feature_local_model.gif)

<br/>

### 🔌 Integração de Ferramentas MCP (MCP)

O ATAI vem com ferramentas massivas integradas do **Protocolo de Contexto de Modelo (MCP)** (para navegação web, execução de código, Notion, Google suite, Slack etc.), e também permite que você **instale suas próprias ferramentas**. Equipe os agentes com exatamente as ferramentas certas para seus cenários – até mesmo integre APIs internas ou funções personalizadas – para aprimorar suas capacidades.

![MCP](https://atai-ai.github.io/.github/assets/gif/feature_add_mcps.gif)

<br/>

### ✋ Humano no Circuito

Se uma tarefa ficar travada ou encontrar incerteza, o ATAI solicitará automaticamente entrada humana.

![Human-in-the-loop](https://atai-ai.github.io/.github/assets/gif/feature_human_in_the_loop.gif)

<br/>

### 👐 100% Código Aberto

O ATAI é completamente de código aberto. Você pode baixar, inspecionar e modificar o código, garantindo transparência e promovendo um ecossistema impulsionado pela comunidade para inovação multi-agente.
...
Descubra como desenvolvedores em todo o mundo aproveitam as capacidades de Cowork código aberto do ATAI para automatizar fluxos de trabalho complexos e aumentar a produtividade em diversos setores.

### 1. Itinerário de Viagem de Tênis em Palm Springs com Resumo no Slack [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM0MzUxNTEzMzctNzExMyI.aIeysw.MUeG6ZcBxI1GqvPDvn4dcv-CDWw__1753435151337-7113)
...
### 2. Gerar Relatório do Q2 a partir de Dados Bancários em CSV [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM1MjY4OTE4MDgtODczOSI.aIjJmQ.WTdoX9mATwrcBr_w53BmGEHPo8U__1753526891808-8739)
...
### 5. Auditoria de SEO para Lançamento do Workforce Multiagent [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM2OTk5NzExNDQtNTY5NiI.aIex0w.jc_NIPmfIf9e3zGt-oG9fbMi3K4__1753699971144-5696)
...
### 6. Identificar Arquivos Duplicados em Downloads [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM3NjAzODgxNzEtMjQ4Ig.aIhKLQ.epOG--0Nj0o4Bqjtdqm9OZdaqRQ__1753760388171-248)
...
### 7. Adicionar Assinatura a PDF [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTQwOTU0ODM0NTItNTY2MSI.aJCHrA.Mg5yPOFqj86H_GQvvRNditzepXc__1754095483452-5661)
...
O desktop ATAI Cowork código aberto é construído com tecnologias modernas e confiáveis que garantem escalabilidade, desempenho e extensibilidade.
...
> [!IMPORTANT]
>
> **Dê uma estrela no ATAI**, você receberá todas as notificações de lançamento do GitHub sem qualquer atraso ~ ⭐️
...
Acreditamos em construir confiança e abraçar todas as formas de colaboração open source. Suas contribuições criativas ajudam a impulsionar a inovação do `ATAI`. Explore as issues e projetos no GitHub para participar e mostrar do que você é capaz 🤝❤️ [Guia de Contribuição][contribution-link]

## Contribuidores

<a href="https://github.com/atai-ai/atai/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=atai-ai/atai" />
</a>
...
O ATAI é construído sobre as pesquisas e infraestruturas da [CAMEL-AI.org][camel-ai-org-github]. [Patrocinar a CAMEL-AI.org][sponsor-link] tornará o `ATAI` ainda melhor.
...
Para mais informações, entre em contato pelo e-mail info@atai.ai
...
[contribution-link]: https://github.com/atai-ai/atai/blob/main/CONTRIBUTING.md
[discord-image]: https://img.shields.io/discord/1082486657678311454?logo=discord&labelColor=%20%235462eb&logoColor=%20%23f5f5f5&color=%20%235462eb
[discord-url]: https://discord.com/invite/CNcNpquyDc
[docs-site]: https://docs.atai.ai
[download-shield]: https://img.shields.io/badge/Download%20ATAI-363AF5?style=plastic
[atai-download]: https://www.atai.ai/download
[atai-github]: https://github.com/atai-ai/atai
[atai-site]: https://www.atai.ai
[github-issue-link]: https://github.com/atai-ai/atai/issues
[github-star]: https://img.shields.io/github/stars/atai-ai?color=F5F4F0&labelColor=gray&style=plastic&logo=github
[image-head]: https://atai-ai.github.io/.github/assets/head.png
[image-join-us]: https://camel-ai.github.io/camel_asset/graphics/join_us.png
[image-opensource]: https://atai-ai.github.io/.github/assets/opensource.png
[image-public-beta]: https://atai-ai.github.io/.github/assets/banner.png
[image-seperator]: https://atai-ai.github.io/.github/assets/seperator.png
[image-star-us]: https://atai-ai.github.io/.github/assets/star-us.gif
[join-us]: https://atai-ai.notion.site/atai-ai-careers
[join-us-image]: https://img.shields.io/badge/Join%20Us-yellow?style=plastic
[reddit-image]: https://img.shields.io/reddit/subreddit-subscribers/CamelAI?style=plastic&logo=reddit&label=r%2FCAMEL&labelColor=white
[reddit-url]: https://www.reddit.com/r/CamelAI/
[social-x-link]: https://x.com/ATAI_AI
[social-x-shield]: https://img.shields.io/badge/-%40ATAI_AI-white?labelColor=gray&logo=x&logoColor=white&style=plastic
