...
### ATAI: The Open Source Cowork Desktop to Unlock Your Exceptional Productivity
...
**English** · [Português](./README_PT-BR.md) · [简体中文](./README_CN.md) · [日本語](./README_JA.md) · [Official Site][atai-site] · [Documents][docs-site] · [Feedback][github-issue-link]

</div>
<br/>

**ATAI** is the open source Cowork desktop application, empowering you to build, manage, and deploy a custom AI workforce that can turn your most complex workflows into automated tasks. As a leading open-source Cowork product, ATAI brings together the best of open-source collaboration and AI-powered automation.
...
> **🔓 Build in Public** — ATAI is **100% open source** from day one. Every feature, every commit, every decision is transparent. We believe the best AI tools should be built openly with the community, not behind closed doors.

### 🏠 Local Deployment (Recommended)

The recommended way to run ATAI — fully standalone with complete control over your data, no cloud account required.
...
> Note: This mode connects to ATAI cloud services and requires account registration. For a fully standalone experience, use [Local Deployment](#-local-deployment-recommended) instead.
...
📧 For further details, please contact us at [info@atai.ai](mailto:info@atai.ai).

### ☁️ Cloud Version

For teams who prefer managed infrastructure, we also offer a cloud platform. The fastest way to experience ATAI's multi-agent AI capabilities without setup complexity. We'll host the models, APIs, and cloud storage, ensuring ATAI runs flawlessly.
...
<div align="right">
<a href="https://www.atai.ai/download">Get started at ATAI.ai →</a>
</div>

## **✨ Key features - Open Source Cowork**

Unlock the full potential of exceptional productivity with ATAI's open-source Cowork powerful features — built for seamless integration, smarter task execution, and boundless automation.

### 🏭 Workforce

Employs a team of specialized AI agents that collaborate to solve complex tasks. ATAI's open-source Cowork dynamically breaks down tasks and activates multiple agents to work **in parallel.**

ATAI pre-defined the following agent workers:
...
Deploy the ATAI open-source Cowork desktop locally with your preferred models.
...
If a task gets stuck or encounters uncertainty, ATAI will automatically request human input.
...
ATAI is completely open-sourced. You can download, inspect, and modify the code, ensuring transparency and fostering a community-driven ecosystem for multi-agent innovation.
...
Discover how developers worldwide leverage ATAI's open-source Cowork capabilities to automate complex workflows and boost productivity across diverse industries.

### 1. Palm Springs Tennis Trip Itinerary with Slack Summary [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM0MzUxNTEzMzctNzExMyI.aIeysw.MUeG6ZcBxI1GqvPDvn4dcv-CDWw__1753435151337-7113)
...
### 2. Generate Q2 Report from CSV Bank Data [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM1MjY4OTE4MDgtODczOSI.aIjJmQ.WTdoX9mATwrcBr_w53BmGEHPo8U__1753526891808-8739)
...
### 3. UK Healthcare Market Research Report Automation [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTMzOTM1NTg3OTctODcwNyI.aIey-Q.Jh9QXzYrRYarY0kz_qsgoj3ewX0__1753393558797-8707)

<details>
<summary><strong>Prompt:</strong> <kbd>Analyze the UK healthcare industry to support the planning ... <kbd></summary>
<br>
Analyze the UK healthcare industry to support the planning of my next company. Provide a comprehensive market overview, including current trends, growth projections, and relevant regulations. Identify the top 5–10 major opportunities, gaps, or underserved segments within the market. Present all findings in a well-structured, professional HTML report. Then send a message to slack #atair-product-test channel when this task is done to align the report content with my teammates.
</details>

<br>

### 4. German Electric Skateboard Market Feasibility [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM2NTI4MjY3ODctNjk2Ig.aIjGiA.t-qIXxk_BZ4ENqa-yVIm0wMVyXU__1753652826787-696)
...
### 5. SEO Audit for Workforce Multiagent Launch [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM2OTk5NzExNDQtNTY5NiI.aIex0w.jc_NIPmfIf9e3zGt-oG9fbMi3K4__1753699971144-5696)
...
### 6. Identify Duplicate Files in Downloads [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTM3NjAzODgxNzEtMjQ4Ig.aIhKLQ.epOG--0Nj0o4Bqjtdqm9OZdaqRQ__1753760388171-248)
...
### 7. Add Signature to PDF [Replay ▶️](https://www.atai.ai/download?share_token=IjE3NTQwOTU0ODM0NTItNTY2MSI.aJCHrA.Mg5yPOFqj86H_GQvvRNditzepXc__1754095483452-5661)
...
ATAI open-source Cowork desktop is built on modern, reliable technologies that ensure scalability, performance, and extensibility.
...
> [!IMPORTANT]
>
> **Star ATAI**, You will receive all release notifications from GitHub without any delay ~ ⭐️
...
We believe in building trust and embracing all forms of open-source collaborations. Your creative contributions help drive the innovation of `ATAI`. Explore our GitHub issues and projects to dive in and show us what you’ve got 🤝❤️ [Contribution Guideline][contribution-link]
...
ATAI is built on top of [CAMEL-AI.org][camel-ai-org-github]'s research and infrastructures. [Sponsoring CAMEL-AI.org][sponsor-link] will make `ATAI` better.
...
For more information please contact info@atai.ai
