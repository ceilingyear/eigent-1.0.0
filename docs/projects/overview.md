...
description: Understand how Spaces, Projects, Sessions, and Runs organize work in ATAI.
icon: folder-kanban
---
...
ATAI organizes work into four levels:
...
ATAI creates the Project and opens its live Session.

## Continue a project

Submit a follow-up request in the same conversation. ATAI adds a new Run while preserving earlier prompts, progress, and outputs.
...
An achieved project is complete. If a run is still active when you end the project, ATAI stops that run before saving the achieved state.
