...
A Session combines the project conversation with live execution details. It is the main surface for reviewing what ATAI understood, what its agents are doing, and what they produced.
...
Enter another request in the composer. ATAI adds the request as a new Run. Use the Run selector to switch the side panel and workspaces between runs.
