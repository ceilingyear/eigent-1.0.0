...
description: Extend ATAI with hosted integrations, Google Search, and custom MCP servers.
icon: plug
---
...
Installing a connector makes its tools available to ATAI. To use it in Workforce:
