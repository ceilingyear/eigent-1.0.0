---
title: Google Search
description: Configure web search for managed and self-hosted ATAI deployments.
...
> Find the three most recent official release notes for ATAI and return their publication dates and source links.
