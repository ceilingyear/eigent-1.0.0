...
Use credentials created specifically for ATAI. Avoid personal administrator tokens.
...
Uninstalling removes the ATAI connector configuration. Revoke OAuth grants or provider tokens separately when required.
