...
4. Wait for ATAI to refresh the cookie list.
5. Restart ATAI when prompted.
...
ATAI deletes cookies for the main domain and its listed subdomains.

## Delete all cookies

1. Select **Delete all**.
2. Confirm the action.
3. Restart ATAI when prompted.
...
Restart ATAI, confirm the domain appears in the list, and check whether the website uses another domain or additional authentication.

### Deleting cookies does not sign out immediately

Restart ATAI and close other browser sessions. The service can also maintain server-side sessions until they expire or are revoked.
