...
description: Give ATAI agents controlled access to browser sessions and authenticated websites.
icon: compass
---

ATAI can launch or connect to Chrome DevTools Protocol browsers for research and browser automation. Browser agents can navigate pages, interact with controls, capture screenshots, and maintain session state.
...
Cookies let agents use authenticated sessions. Open a dedicated login browser, sign in to required services, then let ATAI import the resulting cookie domains.
