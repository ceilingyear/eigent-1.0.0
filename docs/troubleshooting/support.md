...
For account and billing questions, email our support team at [info@atai.ai](mailto:info@atai.ai).

ATAI offers flexible plans for every type of user, from individuals to large enterprises. Our services are divided into two main categories: Cloud and Self-Hosted.

### Cloud Service

Our Cloud Service is a subscription-based offering that gives you access to ATAI's powerful AI models and infrastructure without any setup.
...
>
> _See your Credits Usage directly in Settings → Account → [Manage](https://www.atai.ai/dashboard)._

### Self-Hosted Service

For users who require more control, privacy, and customization, we offer self-hosted solutions. To view more open-source information, please visit [GitHub](https://github.com/atai-ai/atai).
...
For inquiries about our Scalable and Custom plans, please please refer to our [**License**](https://github.com/atai-ai/atai) or email us at **info@atai.ai**.
...
- Credits are the currency you use to power your tasks in ATAI's Cloud Service. Every action that uses our cloud service consumes Credits.
...
- Click **User** icon in the ATAI webpage.
...
- How do I cancel my subscription? Please contact **info@atai.ai.**
- You can download invoices from the payment confirmation email sent to your registered email address.

For any questions about your bill or account status, email us anytime at [info@atai.ai](mailto:info@atai.ai).
