---
title: Gemini
description: This guide walks you through setting up your Google Gemini API key within ATAI to enable the Gemini model for your AI workforce.
---
...
- Launch ATAI and navigate to the **Home Page**.
...
- Once saved, the **"Set as Default"** button on the Gemini Config card will be
  selected/active.
- **You are ready to go.** Your ATAI agents can now utilize the Gemini model.
