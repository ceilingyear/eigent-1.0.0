---
title: Ernie
description: This guide walks you through setting up your Baidu ERNIE API key within ATAI to enable the Ernie model for your AI workforce.
---
...
- Once saved, the **"Set as Default"** button on the Ernie card will be
  selected/active.
- **You are ready to go.** Your ATAI agents can now utilize the Ernie model.
