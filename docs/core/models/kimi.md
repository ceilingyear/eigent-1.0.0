---
title: Kimi
description: This guide walks you through setting up your Kimi (Moonshot AI) API key within ATAI to enable the Kimi model for your AI workforce.
---
...
- Once saved, the **"Set as Default"** button on the Moonshot card will be
  selected/active.
- **You are ready to go.** Your ATAI agents can now utilize the Kimi model.
