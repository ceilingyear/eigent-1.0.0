...
description: Configure your own API keys to use various LLM providers with ATAI.
---

## What is BYOK?

**Bring Your Own Key (BYOK)** allows you to use your own API keys from various AI model providers with ATAI. Instead of relying on a shared service, you connect directly to providers like OpenAI, Anthropic, or Google using your personal API credentials. This gives you:
...
### Step 2: Configure in ATAI

1. Launch ATAI and go to **Agent** > **Models**
...
When saving your configuration, ATAI validates your API key and model. Here are the errors you may encounter:
...
ATAI supports the following BYOK providers:
