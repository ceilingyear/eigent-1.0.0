---
title: SambaNova
description: This guide walks you through setting up your SambaNova API key within ATAI to enable the SambaNova model for your AI workforce.
---
...
- Once saved, the **"Set as Default"** button on the SambaNova card will be
  selected/active.
- **You are ready to go.** Your ATAI agents can now utilize the SambaNova
  model.
