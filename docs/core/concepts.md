---
title: Concepts
description: Understand the core terms and features that make ATAI unique.
icon: key
---
...
Different AI "brains" that power your Workers. ATAI allows you to choose from various models (like GPT-4.1 or Gemini 2.5 Pro), each with different strengths in speed, reasoning, and cost.
