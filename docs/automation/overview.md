...
description: Run ATAI tasks on schedules, webhooks, app events, or remote-control commands.
icon: bolt
---

Automation turns a project prompt into reusable work that can run without manually opening the task composer.

ATAI supports scheduled triggers, webhooks, selected application events, and remote-control commands.
