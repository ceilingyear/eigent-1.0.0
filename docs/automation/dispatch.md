...
description: Control an active ATAI Space from a shareable remote web session.
icon: tower-broadcast
---

Dispatch provides channels for interacting with ATAI away from the desktop application.
...
2. Select **Start**.
3. Wait for ATAI to create the session.
4. Select **Copy link**.
...
Open a Space and confirm the desktop can reach the ATAI server.
