---
title: Tasks
description: Review and manage individual tasks across all ATAI projects.
icon: list-check
---

The Tasks dashboard provides a cross-project view of every request submitted to ATAI. Use it to find work by prompt, status, or date when you do not need to browse the project hierarchy first.
...
- **Planning:** ATAI is preparing or splitting the task.
- **Running:** One or more agents are working.
- **Paused:** Execution is temporarily stopped.
- **Awaiting review:** ATAI needs user input, confirmation, or plan approval.
...
ATAI records elapsed time and sends a pause request to the active task.
