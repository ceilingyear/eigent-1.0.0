...
ATAI adds the request as another run in the same project. See [Project runs](/core/project-runs).
...
If a run is active, ATAI stops it before marking the project achieved. The project remains available in history.
