---
title: Quick Start
description: Get started with ATAI in just a few minutes!
icon: rocket
---

This guide will walk you through building your first multi-agent workforce using ATAI.
...
- **Windows:** `C:\Users\[YourUsername]\atai\[YourEmailPrefix]\task_[TaskID]`
- **Mac:** `/Users/[YourUsername]/atai/[YourEmailPrefix]/task_[TaskID]`
...
ATAI comes with four ready-to-work agents. Each is equipped with a specific set of tools and shines at specific tasks—click to explore:
...
Type your task in the top Message Box. Be as descriptive as you like. For example, ask ATAI to conduct an UK healthcare market research . You can attach files (like docs, data, images) by clicking the **paperclip icon** in the Message Box.Then, hit **Send**.
...
Once you're happy with the plan, hit **Start Task.** ATAI will automatically assign each subtask to the best agent for the job based on the tools they have.
...
- **Language:** ATAI supports multiple languages, including English, Simplified Chinese (简体中文), Traditional Chinese (繁體中文), Japanese (日本語), Korean (한국어), French (Français), German (Deutsch), Spanish (Español), Italian (Italiano), Russian (Русский), and Arabic (العربية).
- **Appearance:** ATAI now supports custom themes, allowing you to personalize the look and feel of your workspace.
...
ATAI can run in two modes. Your choice here affects how you are billed and what models are available.
